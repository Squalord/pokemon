...
public class ChasseAuxPokemons {
	...
	public static void main(String[] args) {
		...
		try(FileReader lecteur = new FileReader("C:/Users/crist/eclipse-workspace/TP11_et_12/src/tp11et12/pokedexComplet.txt")){
		...
		try(FileReader lecteur = new FileReader("C:/Users/crist/eclipse-workspace/TP11_et_12/src/tp11et12/InputFile.txt")){
			Scanner s = new Scanner(lecteur);
			while(s.hasNext()) {
				String name = s.next();
				String type = s.next();
